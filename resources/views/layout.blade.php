...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="flex flex-col h-screen bg-grey-darkest font-sans font-normal leading-normal text-white">
        ...
        <div class="p-4 text-center text-sm">
            hosted by <a href="https://m.do.co/c/74b3fe7f3bfa" class="inline-block text-white no-underline hover:underline" target="_blank">digitalocean.com</a><span class="inline-block mx-1 text-grey-dark">•</span><a href="https://tripix.nl" class="inline-block text-white no-underline hover:underline" target="_blank">tripix.nl</a><span class="inline-block mx-1 text-grey-dark">•</span><a href="{{ url('feed') }}" class="inline-block text-white no-underline hover:underline" target="_blank">rss</a>
        </div>
    </body>
</html>
